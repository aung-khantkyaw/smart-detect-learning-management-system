...
import { ArrowRight, Brain, BarChart3, MessageSquare, TrendingUp, BookOpen, Users, Zap } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-purple-800">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
          Personalized learning paths, real-time collaboration, 
          and comprehensive progress tracking. Built for modern learners and educators.
        </p>
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="flex space-x-8 mb-8 border-b border-gray-200">
                <button className="pb-4 px-2 border-b-2 border-blue-600 text-blue-600 font-semibold">Dashboard</button>
                <button className="pb-4 px-2 text-gray-500 hover:text-gray-700">My Courses</button>
                <button className="pb-4 px-2 text-gray-500 hover:text-gray-700">Assignments</button>
                <button className="pb-4 px-2 text-gray-500 hover:text-gray-700">Grades</button>
                <button className="pb-4 px-2 text-gray-500 hover:text-gray-700">Calendar</button>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-purple-600 text-sm font-medium">Assignments Due</p>
                ...
                <div className="bg-orange-50 rounded-xl p-6 border border-orange-200">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-orange-600 text-sm font-medium">Average Grade</p>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-900 text-sm">Computer Science 101</h4>
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-900 text-sm">Data Structures</h4>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 border-l-4 border-red-500 bg-red-50 rounded-r-lg">
                      <div>
                        <h4 className="font-semibold text-gray-900 text-sm">Final Project</h4>
                        <p className="text-xs text-gray-500">Computer Science 101</p>
                      </div>
                      <span className="text-xs font-medium text-red-600">Due Tomorrow</span>
                    </div>
                    
                    <div className="flex items-center justify-between p-3 border-l-4 border-yellow-500 bg-yellow-50 rounded-r-lg">
                      <div>
                        <h4 className="font-semibold text-gray-900 text-sm">Algorithm Analysis</h4>
                        <p className="text-xs text-gray-500">Data Structures</p>
                      </div>
                      <span className="text-xs font-medium text-yellow-600">Due in 3 days</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-4">Why Choose Smart LMS?</h2>
          <p className="text-xl text-blue-100 max-w-2xl mx-auto">Powerful features designed for modern education</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center border border-white/20">
            ...
            <p className="text-blue-100">Connect with peers and instructors seamlessly</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center border border-white/20">
            ...
            <p className="text-blue-100">Advanced analytics for personalized insights</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center border border-white/20">
            ...
            <p className="text-blue-100">Real-time monitoring of your learning journey</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#" className="text-blue-100 hover:text-white transition-colors">Status</a></li>
              </ul>
            </div>
          </div>
